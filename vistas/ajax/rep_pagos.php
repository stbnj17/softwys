...
if ($action == 'ajax') {
    ...
    $tables      = "ingresos,  pacientes";
    $campos      = "*";
    $sWhere      = "pacientes.id_paciente=ingresos.id_paciente";
    if ($employee_id > 0) {
        $sWhere .= " and ingresos.id_paciente = '" . $employee_id . "' ";
    }
    if (!empty($daterange)) {
        ...
        while ($row = mysqli_fetch_array($query)) {
            ...
            ?>
                    <tr>
                        ...
                        <td><a class='btn btn-primary btn-sm waves-effect waves-light' href="#" title="Imprimir Ticket" onclick="imprimir_recibo('<?php echo $consulta; ?>');"><i class="fa fa-print"></i>
                        </a></td>
                    </tr>
                    <?php }?>
                </table>
