...
<page pageset='new' backtop='10mm' backbottom='10mm' backleft='15mm' backright='15mm' style="font-size: 14px; font-family: helvetica">
  ...
  <table style="width: 100%; border: solid 0px black;" cellspacing=0>
    <tr>
      ...
      <td style="text-align: center;    width: 34%;font-size: 14px; font-weight: bold">Reporte de Ingresos</td>
...
<table  cellspacing="0" style="width: 100%; text-align: left; font-size: 10px; border: 0px solid #000000;">
  <tr class="midnight-blue">
    ...
    <th class="formato" style="width:10%;text-align:center">Tipo</th>
    ...
    <th class="formato" style="width:10%;text-align:center">Usuario</th>
  </tr>
  <?php
...
//SUB CONSULTA
    $sql_sub = mysqli_query($conexion, "SELECT * FROM ingresos WHERE month(fecha_added)='" . $fecha_mes . "' and year(fecha_added)='" . $anio_inicio . "' $xWhere $yWhere");
    while ($roww = mysqli_fetch_array($sql_sub)) {
      ...
      <tr>
        ...
        <td class="formato" style="width: 10%"><?php echo $tip; ?></td>
        <td class="formato" style="width: 10%"><?php echo $tipoo; ?></td>
        ...
        <td class="formato" style="width: 10%"><?php echo $nombre_users; ?></td>
      </tr>
      <?php
}
    ...
    ?>
      ...
      <tr>
        <td colspan="6" style="text-align: right;  font-size: 12px;"><b>Total Mes <?php echo $simbolo_moneda; ?></b></td>
...
$sql       = mysqli_query($conexion, "select  SUM(ofrenda) as total_ast from asistencias $xWhere");
$rw        = mysqli_fetch_array($sql);
...
?>
  ...
  <br>
   <table cellspacing="0" style="width: 100%; font-size: 12pt; border: 1px solid #000000;">
    <tr>
      <td style="width: 70%; text-align: right;"><b>Ingresos de Celulas Familiares <?php echo $simbolo_moneda; ?></b></td>
      <td style="width: 30%; text-align: left;"><b><?php echo number_format($total_ast, 2); ?></b></td>
    </tr>
  </table>
  <br>
  <table cellspacing="0" style="width: 100%; font-size: 12pt; border: 1px solid #000000;">
    <tr>
      ...
      <td style="width: 30%; text-align: left;"><b><?php echo number_format($total_full + $total_ast, 2); ?></b></td>
    </tr>
  </table>
</page>
