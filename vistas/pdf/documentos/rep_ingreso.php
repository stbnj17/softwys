...
$sWhere .= " and ingresos.cod_ingreso=1 GROUP BY month(fecha_added) order by month(fecha_added) asc";
// Consulta la manda a la siguiente pagina
$query = mysqli_query($conexion, "SELECT $campos FROM  $tables where $sWhere ");

// get the HTML
ob_start();
include dirname(__FILE__) . '/res/rep_ingreso_html.php';
