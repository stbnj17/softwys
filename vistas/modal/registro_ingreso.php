		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title"><i class='fa fa-edit'></i> Nueva Ofrenda</h4>
				</div>
						...
						<div class="row">
							<div class="col-md-12">
								<div class="form-group">
									...
									<input type="text" class="form-control" placeholder="Buscar Miembor por Nombre" id="nombre_miembro" par autocomplete="off" style=" background-color:#A9D0F5; border-radius: 5px; border: 1px solid #39c" value="<?php echo isset($row["nombre_miembro"]) . ' ' . isset($row["apellido_miembro"]); ?>" required>
									<input id="id_miembro" name="id_miembro" type='hidden' value="<?php echo $row["id_miembro"]; ?>">
