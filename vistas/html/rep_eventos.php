						...
						<div class="portlet">
							<div class="portlet-heading bg-purple">
								<h3 class="portlet-title">
									Reportes de Seminarios y Eventos
								</h3>
											...
											<div class="col-xs-5 ">
												<div class="btn-group pull-right">
													<?php if ($permisos_editar == 1) { ?>
														<button type="button" onclick="reporte();" class="btn btn-default btn-outline-secondary btn-rounded waves-effect waves-light"><i class='fa fa-print'></i> Imprimir</button>
													<?php } ?>
												</div>
											</div>
										</div>
...
<script>
	function reporte() {
		...
		VentanaCentrada('../pdf/documentos/rep_evento.php?daterange=' + daterange + "&employee_id=" + employee_id, 'Reporte', '', '800', '600', 'true');
	}
</script>
