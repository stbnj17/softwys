...
if ($permisos_editar == 1) {
    include '../modal/registro_ast.php';
    include "../modal/editar_ast.php";
...
?>
								<form class="form-horizontal" role="form" id="datos_cotizacion">
									<div class="form-group row">
										...
										<div class="col-md-3">
											<div class="input-group">
												<select id="cel" name="cel" class="form-control" onchange="load(1);">
													<option value="">CELULAS</option>
...
?>
										...
										<div class="col-md-2">
												...
												<button type="button" class="btn btn-primary btn-rounded waves-effect waves-light" data-toggle="modal" data-target="#nuevoAst"><i class="fa fa-plus"></i> Agregar</button>
												</div>
...
<script>
	function reporte(){
		...
		var cel=$("#cel").val();
		VentanaCentrada('../pdf/documentos/rep_ast.php?daterange='+daterange+"&cel="+cel,'Reporte','','800','600','true');
	}
</script>
<script>
  function reporte_excel(){
    var daterange=$("#range").val();
    var cel=$("#cel").val();
    window.location.replace("../excel/rep_ast.php?daterange="+daterange+"&cel="+cel);
