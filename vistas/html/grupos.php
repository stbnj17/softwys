										...
										<div class="col-md-4">
											...
											<div class="col-md-4">
												<div class="btn-group pull-center">
													<button type="button" class="btn btn-primary btn-rounded waves-effect waves-light" data-toggle="modal" data-target="#nuevoGrupo"><i class="fa fa-plus"></i> Agregar</button>
												</div>
