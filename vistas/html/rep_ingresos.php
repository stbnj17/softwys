...
<script type="text/javascript" src="../../js/rep_ingresos.js"></script>
	<script>
		$(function() {
...
<script>
	function reporte(){
		...
		var tipo=$("#tipo").val();
		var tipoo=$("#tipoo").val();
		VentanaCentrada('../pdf/documentos/rep_ingreso_gen.php?daterange='+daterange+"&tipo="+tipo+"&tipoo="+tipoo,'Reporte','','800','600','true');
	}
</script>
<script>
  function reporte_excel(){
    var daterange=$("#range").val();
    var tipoo=$("#tipoo").val();
    window.location.replace("../excel/rep_ingresos.php?daterange="+daterange+"&tipoo="+tipoo);
