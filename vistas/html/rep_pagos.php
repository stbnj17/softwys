...
<script>
  function reporte(){
    ...
    VentanaCentrada('../pdf/documentos/rep_pagos.php?daterange='+daterange+"&employee_id="+employee_id,'Reporte','','800','600','true');
  }
</script>
<script>
  function imprimir_recibo(id_ingreso) {
		    VentanaCentrada('../pdf/documentos/rep_comprobante.php?id_ingreso=' + id_ingreso, 'Reporte', '', '800', '600', 'true');
		}
</script>
