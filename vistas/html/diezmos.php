						...
						<div id="bg-primary" class="panel-collapse collapse show">
							<div class="portlet-body">
								...
								if ($permisos_editar == 1) {
									include '../modal/registro_diezmo.php';
									include "../modal/editar_diezmo.php";
...
<script type="text/javascript" src="../../js/diezmos.js"></script>
<script>
	$(function() {
...
<script>
	function reporte() {
		...
		var tipoo = $("#tipoo").val();
		VentanaCentrada('../reportes/rep_diezmos.php?daterange=' + daterange + "&tipoo=" + tipoo, 'Reporte', '', '800', '600', 'true');
	}

	function reporte2() {
		var daterange = $("#range").val();
		var tipoo = $("#tipoo").val();
		VentanaCentrada('../reportes/rep_diezmos2.php?daterange=' + daterange + "&tipoo=" + tipoo, 'Reporte', '', '800', '600', 'true');
	}
</script>
<script>
	function reporte_excel() {
		var daterange = $("#range").val();
		var tipoo = $("#tipoo").val();
		window.location.replace("../excel/rep_diezmos.php?daterange=" + daterange + "&tipoo=" + tipoo);
