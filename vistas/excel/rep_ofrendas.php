...
$consulta  = "SELECT * FROM ingresos WHERE fecha_added between '$fecha_inicial' and '$fecha_final' $where and cod_ingreso=1  ORDER BY id_ingreso";
...
if ($resultado->num_rows > 0) {
    ...
    $objPHPExcel->getProperties()->setCreator("Codedrinks") //Autor
        ...
        ->setDescription("Reporte de Ofrendas")
        ->setKeywords("reporte ofrendas")
        ->setCategory("Reporte excel");

    $tituloReporte   = "Reporte de Ofrendas";
    ...
    header('Content-Disposition: attachment;filename="Reporte_Ofrendas.xlsx"');
